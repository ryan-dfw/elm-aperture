...
export const caseStudies = {
    holidayInnExpress: {
        title: 'View a Full Hotel Delivery',
        route: '/hotel-full',
        heroName: 'hotel',
        featuredImage: '345',
        desktopText: 'Click to inspect 300+ delivered images covering rooms, lobbies, amenities, exteriors, and guest-facing spaces.',
        mobileText: 'Tap to view a full hotel delivery',
    },
} as const;
