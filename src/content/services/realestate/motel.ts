...
export const caseStudies = {
    riverValleyInn: {
        title: 'View a Full Motel Delivery',
        route: '/motel-full',
        heroName: 'motel',
        featuredImage: '006',
        desktopText: 'Click to inspect 100+ delivered images covering rooms, signage, amenities, bathrooms, exteriors, and property details.',
        mobileText: 'Tap to view a full motel delivery',
    },
} as const;
